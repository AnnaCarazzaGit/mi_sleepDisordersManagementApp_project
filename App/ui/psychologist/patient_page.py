...
class PatientPagePsychologist(ctk.CTkFrame):
    def __init__(self, master, main_window):
        ...
        # Back to Home button
        create_secondary_button(self, "Back to Home", command=lambda: self.main_window.show_page("home_psychologist")).pack(pady=10)
    ...
    def display_patient_info(self, data):
        ...
        self.add_info_row("Last Consult", data.get("Last_Consult", "N/A"))
        self.add_info_row("Next Consult", data.get("Next_Consult", "N/A"))
        ...
        create_primary_button(
            self.result_frame,
            "View Notes",
            command=lambda: self.main_window.open_note_page(self.patient_id)
        ).pack(pady=5)
