...
def generate_time_slots(start_hour=9, end_hour=12, interval_minutes=15):
...
class CalendarPage(ctk.CTkFrame):
    def __init__(self, master, main_window):
        ...
        # Home button
        create_secondary_button(self, "Back to Home", command=lambda: self.main_window.show_page("home")).pack(padx=10)
    ...
    def build_table(self):
        ...
        for day in DAYS:
            ctk.CTkLabel(header_row, text=day, width=130, anchor="center").pack(side="left", padx=1)
    ...
    def update_calendar(self):
        ...
        visits = self.main_window.db.get_visits_for_week(doctor_id, iso_dates[0], iso_dates[-1])
    ...
    def add_appointment_popup(self, time_str, column):
        ...
        def save():
            ...
            try:
                self.main_window.db.add_appointment(
                    doctor_id=self.main_window.current_user["id"],
