...
class DiaryPagePsychologist(ctk.CTkFrame):
    def __init__(self, master, main_window, patient_id=None):
        ...
        create_secondary_button(self, "Back", command=lambda: self.main_window.show_page("patient_psychologist")).pack(pady=10)
    ...
    def report_to_patient(self):
        show_custom_error(self, title="Alert Sent", message="Situation reported to the patient.")
