...
class ProfilePagePsychologist(ctk.CTkFrame):
    ...
    def load_user_data(self):
        ...
        user_data = self.db.get_psychologist_by_id(user_id)
    ...
    def save_data(self):
        ...
        show_custom_confirm(
            ...
            on_yes=self.apply_profile_changes(phone, address, email, password)  
        )
    ...
    def apply_profile_changes(self, phone, address, email, password):
        ...
        try:
            self.db.update_psychologist_profile(
                user_id=user_id,
                phone=phone,
                address=address,
                email=email,
